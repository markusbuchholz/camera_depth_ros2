...
class HandPoseEstimationNode(Node):
    def __init__(self):
        ...
        # Subscribe to 'video_frames' topic.
        ...
        # Publisher for '/xsubsea/joint_trajectory'
        ...
        # Publisher for '/target_position' (retain if needed)
        ...
        # Define scaling factor for display (e.g., 2 for double size)
    ...
    def image_callback(self, msg):
        ...
        if results.multi_hand_landmarks and results.multi_handedness:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks, results.multi_handedness):
                ...
                # Publish JointTrajectory commands
                self.publish_joint_trajectory(gripper_state)
    ...
    def publish_joint_trajectory(self, gripper_state):
        """
        ...
        self.get_logger().info(f'Published JointTrajectory with axis_a: {positions[0]}')
